...
<body>
    ...
    <div class="navigation-bar">
        ...
        <div class="menu">
            ...
            <div class="item-menu" onclick="location.href='show-catalog-servlet?first=1&last=6'" data-name="Catalogo"><i class="fa-solid fa-book-open iconMenu"></i>Catalogo</div>
