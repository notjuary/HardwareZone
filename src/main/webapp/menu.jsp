...
<body>
    ...
    <div class="navigation-bar">
        ...
        <div class="menu">
            ...
            <div class="item-menu" onclick="location.href='Cart.jsp'" data-name="Carrello"><i class="fa-solid fa-cart-shopping iconMenu"></i>Carrello <span id="count"><%= numberObject %></span></div>
